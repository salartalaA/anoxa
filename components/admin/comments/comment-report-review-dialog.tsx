...
interface CommentReportReviewDialogProps {
  date: string | Date;
...
export function CommentReportReviewDialog({
  date,
  onOpenChange,
  onStatusChange,
  open,
  ...
  reportId,
  status,
}: CommentReportReviewDialogProps) {
  ...
  const handleStatusChange = async (newStatus: ReportStatus) => {
    ...
    await updateCommentReportStatus(reportId, newStatus);
  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Comment Report Review</DialogTitle>

          <DialogDescription>
            Review the reported comment and take action.
          </DialogDescription>
        </DialogHeader>
